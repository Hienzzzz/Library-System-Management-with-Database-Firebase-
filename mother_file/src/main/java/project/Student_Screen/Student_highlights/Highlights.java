package project.Student_Screen.Student_highlights;
...
public class Highlights extends javax.swing.JPanel {
    ...
    public Highlights(MainFrame frame){
        this.frame = frame;
        panel();
    }
    public void panel(){
        ...
        this.setPreferredSize(new Dimension(1512, 982));
         ...
         ImageIcon icon = new ImageIcon(
            getClass().getResource("/Images/Student_highlights.png")
        );
