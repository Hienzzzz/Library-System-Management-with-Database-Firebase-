    ...
    public EditBookPanel(
        ...
        JLabel background = new JLabel(
                new ImageIcon(getClass()
                        .getResource("/Images/ADmin_editBook.png"))
        );
        ...
        scrollPane.getVerticalScrollBar()
            ...
            protected void paintThumb(
                    Graphics g, JComponent c, Rectangle r){
        ...
        saved_button.addActionListener(e -> {
            ...
            if (selectedFile[0] != null) {
                ...
                if (book.getCoverURL() != null &&
                    ...
                    ImageService.deleteBookCoverByUrl(
                            book.getCoverURL()
                    );
                }

                String newCover =
                        ImageService.uploadBookCover(
                                selectedFile[0],
                                book.getBookId()
                        );
            ...
            updates.put("description",
                    description.getText().trim());
            updates.put("quantity",
                    (int) quantityButton.getValue());
            updates.put("coverURL",
                    book.getCoverURL());

            BookService.updateBookFields(
                    book.getBookId(),
                    updates
            );
